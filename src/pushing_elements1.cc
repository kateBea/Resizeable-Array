...
public:
    ...
    Resource(const Resource& other) : identifier_{ other.identifier_ } { std::cerr << "Copying: " << identifier_ << '\n'; }
...
int main(int, char**) {
    ...
    std::cout << "\nCALL TO push_back(const T&)...\n";
    resources.push_back(static_cast<const Resource&>(Resource(::get_random_integer())));
    resources.push_back(static_cast<const Resource&>(Resource(::get_random_integer())));
    resources.push_back(static_cast<const Resource&>(Resource(::get_random_integer())));
    resources.push_back(static_cast<const Resource&>(Resource(::get_random_integer())));
    resources.push_back(static_cast<const Resource&>(Resource(::get_random_integer())));
